...
router.post(
  "/staff/solvedTickets/:staffID",
  dashboardController.getStaffSolvedTicketCount
);

// Get count of Tickets solved
router.post(
  "/staff/solvedTickets",
  dashboardController.getAllStaffSolvedTicketCounts
);

// Get count of Tickets solved department wise
router.get(
  "/departments/solvedTickets",
  dashboardController.getSolvedTicketsByDepartment
);

// Get solved and pending ticket counts
router.get(
  "/tickets/solvedTickets",
  dashboardController.getSolvedAndPendingTicketCounts
);

// Get solved ticket counts date-wise for the current week
router.get(
  "/tickets/solvedAndPendingTickets",
  dashboardController.getTicketCountsOverTime
);

// Get recently solved ticket details by a specific staff member
router.get(
  "/staff/recentSolvedTickets/:staffID",
  dashboardController.getRecentlySolvedTicketByStaff
);

// Get all solved ticket details by a specific staff member
router.get(
  "/staff/solvedTicketsHistory/:staffID",
  dashboardController.getAllSolvedTicketsByStaff
);
