...
// Connect to MongoDB
mongoose.connect(fullMongoURI, { useNewUrlParser: true, useUnifiedTopology: true })
    .then(() => {
            ...
            schemas: {
                ...
                Ticket: {
                    ...
                    properties: {
                        ...
                        staffID: { type: "string", description: "ID of the staff assigned to the ticket" },
                        departmentID: { type: "string", description: "ID of the department related to the ticket" },
                        status: { type: "string", enum: ["Pending", "Solved"], description: "Current status of the ticket" },
                        createdDate: { type: "string", format: "date-time", description: "Date and time when the ticket was created" },
                        closedDate: { type: "string", format: "date-time", description: "Date and time when the ticket was closed" },
                ...
                TicketInput: {
                    ...
                    required: ["title", "description", "staffID", "departmentID", "status", "createdDate"],
                    example: {
                        title: "Issue with login",
                        description: "Cannot log into the system with valid credentials.",
                        staffID: "60c72b2f9b1e8c001f5f7c6f",
